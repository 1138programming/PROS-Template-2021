...
Base::Base() {
    ...
    frontRightMotor = new pros::Motor(frontRightBasePort, baseMotorGearset, false, globalEncoderUnits);
    backLeftMotor = new pros::Motor(frontLeftBasePort, baseMotorGearset, false, globalEncoderUnits);
    backRightMotor = new pros::Motor(frontRightBasePort, baseMotorGearset, false, globalEncoderUnits);
